        ...
        <div className="faculties-container">
            ...
            <div className="faculties-list">
                <div className="faculty-column">
                    <Link to="/faculties/business-economics">
                    ...
                    <Link to="/faculties/languages-cultures-communication">
                        <div className="faculty-item">
                    ...
                    <Link to="/faculties/contemporary-social-sciences">
                        <div className="faculty-item">
                ...
                <div className="faculty-column">
                    <Link to="/faculties/contemporary-sciences-technologies">
                        <div className="faculty-item">
                    ...
                    <Link to="/faculties/doctoral-school">
                        <div className="faculty-item">
